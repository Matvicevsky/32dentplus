export const EMPLOYEES: {
...
}[] = [
	{
		...
		services: [
			'съемное протезирование (бюгельные протезы, нейлоновые протезы, гипоаллергенные akril-free протезы)',
			'металлокерамика',
	...
	},
	{
		...
		education: [
			...
			'участие в обучающем семинаре «Немедленная нагрузка на классических имплантатах. Протокол восстановление зубного ряда  «все на 4 » и «все на 6″ картикальные и скуловые имплантаты»',
	...
	},
	{
		...
		services: [
			...
			'Восстановление функции и эстетики съемными конструкциями',
		],
		certificates: [
	...
	},
	{
		...
		category: 'первая',
		experience: 16,
		image: '/doctors/gytirchik_maria/gytirchik_maria.jpg',
		training: [
			'Современные подходы к профилактике стоматологических заболеваний',
			'Альтернативные методы антимикробной обработки в эндодонтии и периодонтологии',
			'Актуальные вопросы ортопедической стоматологии',
		],
		education: ['Микроскопная эндодонтия.'],
		services: [
			'Лечение кариеса',
			'Неинвазивное лечение кариеса (система Icon)',
			'Отбеливание',
