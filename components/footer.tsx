          ...
          <div className="flex flex-wrap">
            <div className="flex flex-col items-start  w-full md:w-2/3 md:pr-[15%] mb-4 md:mb-0">
              <p className="md:text-[1.39vw] md:mb-[4.09vw]">
                18+. МЕДИЦИНСКАЯ ИНФОРМАЦИЯ НА САЙТЕ НОСИТ ОЗНАКОМИТЕЛЬНЫЙ ХАРАКТЕР. ИМЕЮТСЯ
                ПРОТИВОПОКАЗАНИЯ. ОБЯЗАТЕЛЬНО ПРОКОНСУЛЬТИРУЙТЕСЬ СО СПЕЦИАЛИСТОМ.
              </p>
              <p className="md:text-[1.39vw] hidden md:block">© 2024. Все права защищены.</p>
            </div>
            {selectedCity?.city === 'Минск' && (
            ...
            <p className="md:text-[1.39vw] block md:hidden">© 2024. Все права защищены.</p>
          </div>
        </div>
      </div>
    </footer>
